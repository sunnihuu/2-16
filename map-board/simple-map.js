...
function addLayersForKey(map, key) {
  ...
  if (key === "heatVulnerability") {
    safeAddSource(map, "heatVulnerability", { type: "geojson", data: DATA_SOURCES.heatVulnerability });
    safeAddLayer(map, {
...
const LEGENDS = {
  ...
  heatVulnerability: {
    ...
    subtitle: "Heat vulnerability index rankings",
    items: [{ type: "fill", label: "Heat Vulnerability Area", color: "#fbbf24" }],
  },
};
